...
This project is licensed under the MIT License. See the [LICENSE](https://github.com/spectralpalette/FastA/blob/master/LICENSE) file for details.

# License

This project is licensed under the MIT License. See the [LICENSE](https://github.com/Light00Side/FastA/blob/main/LICENSE) file for details.
